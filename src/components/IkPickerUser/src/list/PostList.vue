 ...
 * @LastEditTime: 2024-05-20 16:06:57
-->
...
<template>
  ...
  <div class="left-pick-list">
    <el-checkbox
      v-model="checkAll"
      v-if="multiple && chooseType.includes('post') && list && list.length"
    ...
    <ul v-if="list && list.length" class="post-view-list">
        ...
        >
          <li v-for="item in list" :key="item[props.fixPropOpt.id]">
            ...
            >
              ...
              <p>{{ item[props.fixPropOpt.name] }}</p>
            </el-checkbox>
            <template v-else>
              <div class="checkText">
                <div class="side"></div>
      ...
      <template v-else>
        ...
        >
          ...
          >
            <el-radio
              v-if="chooseType.includes(item[props.fixPropOpt.type].toLowerCase())"
              :label="item[props.fixPropOpt.id]"
            >
