 ...
 * @LastEditTime: 2024-03-29 10:43:03
-->
<script setup lang="ts" name="IkingDepuserPicker">
import { PropType, Ref, ref } from "vue";
import Picker from "./picker.vue";
// import "../../dist/style.css";
import { TList, EChooseType } from "../types";
import 'iking-utils-pro/dist/dayjs/zh-cn'
// defineProps
...
// [{elementType: 'DEPT', elementName: '自定义一级单位', elementId: 'bcc9640b241e4142984481abf74c7f6d'}]
// [{
...
setTimeout(() => {
  api.value = {
    ...
    url: `http://192.168.2.77/api/component/pick/mix`,
    param: null,
    paramKey: "type",
  }
})
...
<template>
  ...
  <Picker ref="testRef" v-model="handList" v-model:show="isShow" :multiple="true"
    :choose-type="chooseType" :type-option="{ dep: 'DEPT', user: 'USER', role: 'ROLE', post: 'POST' }" :prop-option="{
      name: 'elementName',
      id: 'elementId',
      type: 'elementType',
    }" :api="api" @ok="handSelected"  emptyText="暂无数据" />
</template>
